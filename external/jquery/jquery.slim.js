...
// Microsoft forgot to hump their external prefix (#9572)
...
// Return a external-prefixed property or undefined
function externalPropName( name ) {

	// Check for external prefixed names
...
// Return a potentially-mapped jQuery.cssProps or external prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || externalProps[ name ];
	...
	return externalProps[ name ] = externalPropName( name ) || name;
}
